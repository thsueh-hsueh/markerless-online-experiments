...
export default {
  id: "single-hand-baseline-2d-v5-18-4-angular-slice-320",

  title: "Single-Hand Baseline V5.18.4 ANGULAR SLICE — 320 Reaches + Practice",
      ...
      if (trial.kind === "practice_reaching") {
        if (summary?.blockFinishedNormally !== true) {
          return {
            ...
            failureReason: "practice_block_incomplete",
            reasons: ["practice_block_incomplete"],
          };
        }
