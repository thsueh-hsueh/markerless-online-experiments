...
/* ============================================================
 * SINGLE-HAND INTUITIVE BASELINE — V5.17.0 FINAL TREASURE HUNT
 *
 * Purpose
 * -------
 ...
 * - V5.17.0 FINAL uses isotropic display geometry for the 8-direction reaching array, makes the visible gem radius exactly match the logical hit radius in display units, retains V5.16 wrong-hand guarding, and combines radial return guidance with a near-home XY cursor (<= 0.20 task units).
...
export default {
  id: "single-hand-baseline-2d-v5-17-0-final-test64",

  title: "Single-Hand Baseline V5.17.0 FINAL TEST — 64 Reaches",
