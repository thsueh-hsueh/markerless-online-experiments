...
/* ============================================================
 * SINGLE-HAND INTUITIVE BASELINE — V5.18.3 ANGULAR SLICE + PREFLIGHT GATE
 *
 * Purpose
 * -------
 ...
 *
 * Total = 64 reaches.
 * Each reaching block contains 1 randomized 8-direction cycle.
 *
...
/* Hard safety timeout only; blocks normally end at 8 reaches. */
...
function setupTreasureShellUi() {
  ...
  style.textContent = `
    ...
    #screen-position .camera-performance-reminder {
      max-width:760px; margin:8px auto 10px; color:#dce7f8;
      font:750 1.05rem/1.4 system-ui,sans-serif;
    }
    ...
    @media (max-height:640px) {
      ...
      #screen-position .camera-performance-reminder { font-size:.98rem; margin:5px auto 7px; }
      #treasure-camera-cue .camera-hero { grid-template-columns:1fr; }
      #treasure-camera-cue .camera-copy { text-align:center; }
...
export default {
  id: "single-hand-baseline-2d-v5-18-3-angular-slice-test64",

  title: "Single-Hand Baseline V5.18.3 ANGULAR SLICE TEST — 64 Reaches",
